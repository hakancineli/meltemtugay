...
export default function TourImageSlider({ tourId, images, alt, className = "" }: TourImageSliderProps) {
  ...
  return (
    <div className={`relative overflow-hidden ${className}`}>
      ...
      {/* Navigation Buttons - sadece birden fazla görsel varsa göster */}
      {images.length > 1 && (
        <>
          <button
      ...
      {/* Dot Indicators - sadece birden fazla görsel varsa göster */}
      {images.length > 1 && (
